...
\begin{confkey}{bibtex}{type: \type{string}}
The command to use for the \progname{bibtex} program. Internally, this key is
an alias for the \ckey{command} key in the \progname{bibtex} entry (default:
\code{"bibtex"}). If the \ckey{command} key is specified in the \ckey{programs}
table, this alias is ineffective.
\end{confkey}

\begin{confkey}{clean\_files}{type: \type{array of strings}}[default: see bellow]
...
\begin{confkey}{dvipdf}{type: \type{string}}
The command to use for the \progname{dvipdf} program. Internally, this key is
an alias for the \ckey{command} key in the \progname{dvipdf} entry (default:
\code{"dvipdfmx"}). If the \ckey{command} key is specified in the \ckey{programs}
table, this alias is ineffective.
\end{confkey}

\begin{confkey}{dvips}{type: \type{string}}
The command to use for the \progname{dvips} program. Internally, this key is
an alias for the \ckey{command} key in the \progname{dvips} entry (default:
\code{"dvips"}). If the \ckey{command} key is specified in the \ckey{programs}
table, this alias is ineffective.
\end{confkey}

\begin{confkey}{latex}{type: \type{string}}
The command to use for the \progname{latex} program. Internally, this key is an
alias for the \ckey{command} key in the \progname{latex} entry (default:
\code{"lualatex"}). If the \ckey{command} key is specified in the
...
\begin{confkey}{makeindex}{type: \type{string}}
The command to use for the \progname{makeindex} program. Internally, this key
is an alias for the \ckey{command} key in the \progname{makeindex} entry
(default: \code{"makeindex"}). If the \ckey{command} key is specified in the
\ckey{programs} table, this alias is ineffective.
\end{confkey}
...
\begin{confkey}{programs}{type: \type{table}}
  [default: see Section~\ref{sec:default-config}]
The table that contains the detailed configuration for each program. See
Section~\ref{sec:keys-in-programs} for the details.
\end{confkey}

\begin{confkey}{ps2pdf}{type: \type{string}}
The command to use for the \progname{ps2pdf} program. Internally, this key is
an alias for the \ckey{command} key in the \progname{ps2pdf} entry (default:
\code{"ps2pdf"}). If the \ckey{command} key is specified in the \ckey{programs}
table, this alias is ineffective.
\end{confkey}

\begin{confkey}{sequence}{type: \type{array of strings}}
  [default: \code{["latex", "bibtex", "makeindex", "dvipdf"]}]
...
Section~\ref{sec:default-config}.
\end{confkey}
